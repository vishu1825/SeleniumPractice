...
public class WindowHanding1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("child windows id is: "+ childWindowID2);
		
		driver.switchTo().window(childWindowID2);//switch to child window
	    ...
	    driver.switchTo().window(parentWindowID2); //switch to parent window
